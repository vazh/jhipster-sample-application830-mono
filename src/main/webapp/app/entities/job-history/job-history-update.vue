  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="jhipsterSampleApplication830App.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-history-startDate">Start Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-history-endDate">End Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-history-language">Language</label>
            <select
              class="form-control"
              name="language"
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-history-job">Job</label>
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-history-department">Department</label>
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-history-employee">Employee</label>
