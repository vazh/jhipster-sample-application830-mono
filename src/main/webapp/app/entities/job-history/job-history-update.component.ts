      ...
      if (this.jobHistory.id) {
        this.jobHistoryService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo('A JobHistory is updated with identifier ' + param.id);
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.jobHistoryService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess('A JobHistory is created with identifier ' + param.id);
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
