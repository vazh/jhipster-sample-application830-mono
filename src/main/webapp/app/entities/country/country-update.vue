  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="jhipsterSampleApplication830App.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="country-countryName">Country Name</label>
            <input
              type="text"
              class="form-control"
              name="countryName"
          ...
          <div class="form-group">
            <label class="form-control-label" for="country-region">Region</label>
